...
//Criado por Kaik Rodrigues. Nivel mestre e anteriores. mais ou menos 3h pra terminar, do zero. 137 linhas.
...
int main() {
	...
	printf("Super poder, segunda carta: %.2f \n\n\n\n", soma_propriedades2);	
		...
		//informa ao usuário quem vence,dentre as 3 opções, indicando com 1 quem vence ( opcão verdadeira ) e 0 para opçao falsa:		
		printf("A carta vencedora em propriedades (populaçao,area e PIB), foi:(valor 1 para verdadeira 0 para falso) \n");
		 	printf("carta 1: %d\n", soma_propriedades > soma_propriedades2); // opção 1.
		 	printf("carta 2: %d\n", soma_propriedades < soma_propriedades2); // opcão 2.
		 	printf("Empate, ambas são iguais em soma de suas propriedades. : %d\n\n", soma_propriedades == soma_propriedades2); // opcção 3.
	
		// informa quem vence em densidade com menor valor, do mesmo modo que o antrior.
		printf("A carta vencedora em densidade, possuindo o menor valor foi: (valor 1 para verdadeira 0 para falso)\n");
			printf("Carta 1: %d \n", densidade < densidade2); // opção 1.
			printf("Carta 2: %d \n", densidade > densidade2); // opção 2.
			printf("Emapate, ambas possuem a mesma densidade. : %d\n", densidade == densidade2); // opção 3.
